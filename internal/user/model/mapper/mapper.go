...
func ModelToEntity(model *model.User) domain.User {
	return domain.User{
		Users: domain.Users{
...
func EntityToModel(entity *domain.User) model.User {
	return model.User{
		Users: model.Users{
...
func ListModelToListEntity(listModel []*model.User) []*domain.User {
	listEntity := []*domain.User{}
